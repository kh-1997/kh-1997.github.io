...
## [数据库自增ID](https://snailclimb.gitee.io/javaguide/#/docs/system-design/micro-service/分布式id生成方案总结?id=数据库自增id)
...
## [数据库多主模式](https://snailclimb.gitee.io/javaguide/#/docs/system-design/micro-service/分布式id生成方案总结?id=数据库多主模式)
...
## [号段模式](https://snailclimb.gitee.io/javaguide/#/docs/system-design/micro-service/分布式id生成方案总结?id=号段模式)
...
## [雪花算法](https://snailclimb.gitee.io/javaguide/#/docs/system-design/micro-service/分布式id生成方案总结?id=雪花算法)
...
### [百度（uid-generator）](https://snailclimb.gitee.io/javaguide/#/docs/system-design/micro-service/分布式id生成方案总结?id=百度（uid-generator）)
...
### [美团（Leaf）](https://snailclimb.gitee.io/javaguide/#/docs/system-design/micro-service/分布式id生成方案总结?id=美团（leaf）)
...
### [总结](https://snailclimb.gitee.io/javaguide/#/docs/system-design/micro-service/分布式id生成方案总结?id=总结)

总得来说，上面两种都是自动生成workId，以让系统更加稳定以及减少人工成功。

## [Redis](https://snailclimb.gitee.io/javaguide/#/docs/system-design/micro-service/分布式id生成方案总结?id=redis)
